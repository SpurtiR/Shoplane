let cartNumbers;
  ...
  document.getElementById('cart-count').innerText=cartNumbers;
...
function createItemOnCheckOut(iPreview, iName, iCount, iPrice) {
  ...
  var itemPriceText = document.createTextNode("Amount: " + iPrice);
  itemPrice.appendChild(itemPriceText);

  var itemPriceCount = document.createElement("p");
  var itemPriceCountText = document.createTextNode("Revised Amount: " + iCount * iPrice);
  itemPriceCount.appendChild(itemPriceCountText);
